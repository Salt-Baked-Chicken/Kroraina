    ...
    <content>
        ...
        <div id="introduction_box">
            ...
            <div id="login_choose_box">
                <button class="login_boxbtn" type="button"><b>登陆</b></button>
                <button class="login_boxbtn" type="button"><b>注册</b></button>
            </div>

            <div id="input_box">
                <div id="input_center_box">
                    <input value="注册 - 输入你的账号" name="user_id">
                    <input value="输入密码" name="password">
                    <input value="输入c K 3 n" name="test_robot">
        ...
        <div id="topic_box">
            ...
            <div id="user_box">
                <div id="ut_title"><b>我们这里食堂好糟糕呀</b></div>
                <div id="user_centece">
